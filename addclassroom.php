...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div id="content">
                    <button class="btn btn-success btn-lg " data-toggle="modal" data-target="#myModal"> ADD CLASSROOM</button>
                </div>
        ...
        <div class="modal-dialog " role="document">
          <div class="modal-content" >
            <div class="modal-header" style="background: #2c3e50">
              ...
              <h4 class="modal-title" id="myModalLabel" style="color: white;">Add Classrooms</h4>
            </div>
            <div class="modal-body">
                <form action="addclassroomform.php" method="POST">
                    <div class="form-group">
                        <div class="form-group">
                            <label for="CNO">SR No</label>
                            <input type="text" class="form-control" id="departmentno" name="CNO" placeholder="Serial No ...">
                        </div>


                        <label for="classroomname">Classroom's Name</label>
                        <input type="text" class="form-control" id="classroomname" name="CN"
                               placeholder="Classroom's Name ...">
                    </div>
